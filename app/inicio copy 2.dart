      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          onProgress: (int progress) {
            debugPrint('Cargando WebView (progress : $progress%)');
          },
          onPageStarted: (String url) {
            debugPrint('La pagina se esta cargando: $url');
          },
          onPageFinished: (String url) {
            debugPrint('Pagina cargada: $url');
          },
  ...
  isForMainFrame: ${error.isForMainFrame}
          ...
          onNavigationRequest: (NavigationRequest request) {
            if (request.url.startsWith('https://www.youtube.com/')) {
              debugPrint('Pagina bloqueada: ${request.url}');
              return NavigationDecision.prevent;
            }
            debugPrint('Navegacion permitida ${request.url}');
            return NavigationDecision.navigate;
          },
          onUrlChange: (UrlChange change) {
            debugPrint('La pagina cambio a: ${change.url}');
          },
        ),
      )
